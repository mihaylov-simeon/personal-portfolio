  ...
  { num: "02", label: "Dummy Dataset",      sub: "15-row sales table with deliberate nulls, typos, duplicates, mixed casing" },
  ...
  { num: "06", label: "Output",             sub: "Real I/O tables rendered side by side with null / boolean highlighting" },
];
